...
var RoomInternalState = /* @__PURE__ */ ((RoomInternalState2) => {
  ...
  RoomInternalState2[RoomInternalState2["DISCONNECTING"] = 2] = "DISCONNECTING";
...
class Room {
  ...
  listing;
  clock = new import_timer.default();
  #_roomId;
  #_roomName;
  maxClients = Infinity;
  ...
  set roomId(roomId) {
    if (this.internalState !== 0 /* CREATING */ && !import_DevMode.isDevMode) {
  ...
  async setMetadata(meta) {
    ...
    if (this.internalState === 1 /* CREATED */) {
  ...
  async disconnect(closeCode = import_Protocol.Protocol.WS_CLOSE_CONSENTED) {
    this.internalState = 2 /* DISCONNECTING */;
  ...
  allowReconnection(previousClient, seconds) {
    ...
    if (this.internalState === 2 /* DISCONNECTING */) {
